...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
            ...
            set
            {
                ...
                switch (p_RailType)
                {
                    ...
                    case E_RAIL_TYPE.Arrow_Down:
                        m_RailLength_Pixel = WinFromUtility.RealLengthToPixelsWidthByScale(m_iRailLength);
    ...
    public class GroupRails
    {
        ...
        private PointObject[] m_pPoints;
        private List<uctlNewVehicle> vehicles;
        private Dictionary<string, List<uctlNewVehicle>> dicVehicles;
        ...
        public List<uctlNewVehicle> p_Vehicles
        {
            get { return (vehicles); }
        }
        ...
        public GroupRails(string section_id, double real_sec_distance, E_RAIL_DIR rail_dir, string seg_num, E_RAIL_DIR seg_dir)
        {
            ...
            m_pPoints = new PointObject[2];
            vehicles = new List<uctlNewVehicle>();
            dicVehicles = new Dictionary<string, List<uctlNewVehicle>>();
        }
        ...
        public void VehicleEnterSection(uctlNewVehicle vh, string address_id, double sec_dis)
        {
            ...
            {
                dicVehicles.Add(address_id, new List<uctlNewVehicle>());
            }
            // dicVehicles[address_id].Add(vh);
            vh.CurrentSecID = Section_ID;
            refreshVehicleLoaction(vh, sec_dis);
        }
        public (int LocX, int LocY) getVehicleEnterSectionOfLocation(string address_id, double sec_dis)
        {
            if (!dicVehicles.ContainsKey(address_id))
            {
                dicVehicles.Add(address_id, new List<uctlNewVehicle>());
            }
            return getVehicleLoaction(sec_dis);
        }
