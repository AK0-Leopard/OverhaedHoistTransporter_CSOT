...
namespace com.mirle.ibg3k0.ohxc.winform.UI.Menu_System
{
    partial class ChangeStatusPopupForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "ChangeStatusPopupForm";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Change Status";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.ChangeStatusPopupForm_FormClosed);
            this.Load += new System.EventHandler(this.ChangeStatusPopupForm_Load);
