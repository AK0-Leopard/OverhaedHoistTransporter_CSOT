...
namespace com.mirle.ibg3k0.sc.Data.ValueDefMapAction
{
    public class MTSValueDefMapActionNew : MTxValueDefMapActionBase
    {
        ...
        public override void OHxCResetAllhandshake()
        {
            try
            {
                ValueWrite vw_ReplyAlarmReport = bcfApp.getWriteValueEvent(MTS.EqptObjectCate, MTS.EQPT_ID, "OHXC_TO_MTL_REPLY_ALARM_REPORT_HS");
                ValueWrite vw_MTLAlarmResetRequest = bcfApp.getWriteValueEvent(MTS.EqptObjectCate, MTS.EQPT_ID, "OHXC_TO_MTL_ALARM_RESET_REQUEST_HS");
                ValueWrite vr_CarOutReply = bcfApp.getWriteValueEvent(MTS.EqptObjectCate, MTS.EQPT_ID, "OHXC_TO_MTL_CAR_OUT_REPLY_HS");
                ValueWrite vr_CarOutNotify = bcfApp.getWriteValueEvent(MTS.EqptObjectCate, MTS.EQPT_ID, "OHXC_TO_MTL_CAR_OUT_NOTIFY_HS");
                ValueWrite vr_ReplyCatInDataCheck = bcfApp.getWriteValueEvent(MTS.EqptObjectCate, MTS.EQPT_ID, "OHXC_TO_MTL_REPLY_CAR_IN_DATA_CHECK_HS");
