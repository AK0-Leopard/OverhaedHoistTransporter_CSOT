...
namespace com.mirle.ibg3k0.sc
{
    ...
    public partial class AVEHICLE : BaseEQObject, IConnectionStatusChange
    {
        ...
        public object StatusUpdate_Sync = new object();
        ...
        public void NotifyVhPositionChange()
        {
            ...
            //Task.Run(() => OnPropertyChanged(BCFUtility.getPropertyName(() => this.VhPositionChangeEvent), VEHICLE_ID));
        }
        ...
        private ValueDefMapActionBase getExcuteMapAction()
        {
            ...
            switch (SCApplication.getInstance().BC_ID)
            {
                case SCAppConstants.WorkVersion.VERSION_NAME_TAICHUNG6F:
                    mapAction = this.getMapActionByIdentityKey(typeof(EQTcpIpMapAction_Taichung6F).Name) as EQTcpIpMapAction_Taichung6F;
                    break;
                default:
