        ...
        public void setFourColorLightRedWithBuzzer(bool buzzer_signal, bool light_signal)
        {
            lock (four_color_light_lock)
            {
                FourColorLightValueDefMapAction mapAction =
                    getMapActionByIdentityKey(nameof(FourColorLightValueDefMapAction)) as FourColorLightValueDefMapAction;
                //mapAction.sendFourColorLightRedWithBuzzerSignal(buzzer_signal, light_signal);
                mapAction.sendFourColorLightRedToFlickWithBuzzerSignal(buzzer_signal, light_signal);
            }
        }
        public void setFourColorLightOrange(bool signal)
        {
            lock (four_color_light_lock)
            {
                FourColorLightValueDefMapAction mapAction =
                    getMapActionByIdentityKey(nameof(FourColorLightValueDefMapAction)) as FourColorLightValueDefMapAction;
                mapAction.sendFourColorLightOrangeSignal(signal);
            }
        }
        public void setFourColorLightGreen(bool signal)
        {
            lock (four_color_light_lock)
            {
                FourColorLightValueDefMapAction mapAction =
                    getMapActionByIdentityKey(nameof(FourColorLightValueDefMapAction)) as FourColorLightValueDefMapAction;
                mapAction.sendFourColorLightGreenSignal(signal);
            }
        }
        public void setFourColorLightBlue(bool signal)
        {
            lock (four_color_light_lock)
            {
                FourColorLightValueDefMapAction mapAction =
                    getMapActionByIdentityKey(nameof(FourColorLightValueDefMapAction)) as FourColorLightValueDefMapAction;
                mapAction.sendFourColorLightBlueSignal(signal);
            }
        }
