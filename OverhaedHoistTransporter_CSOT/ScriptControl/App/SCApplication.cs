...
namespace com.mirle.ibg3k0.sc.App
{
    ...
    public class SCApplication
    {
        ...
        //private Guide routeGuideOld = null;
        //public Guide RouteGuideOld { get { return routeGuideOld; } }
        ...
        private void init()
        {
            ...
            //routeGuideOld = new Guide();
            //routeGuideOld.start(this);
            ...
            switch (BC_ID)
            {
                case SCAppConstants.WorkVersion.VERSION_NAME_TAICHUNG6F:
                    bcfApplication.injectTcpIpDecoder(new com.mirle.iibg3k0.ttc.Common.TCPIP.DecodRawData.DecodeRawData_SANWA());
                    break;
                default:
    ...
    com.mirle.ibg3k0.sc.Data.ValueDefMapAction.EQTcpIpMapAction.unPackWrapperMsg));
        ...
        private void loadCSVToDataset(DataSet ds, string tableName)
        {
            using (GenericParser parser = new GenericParser())
            {
                ...
                {
                    if (SCUtility.isMatche(tableName, "ALARMMAP"))
                        parser.SetDataSource(Environment.CurrentDirectory + this.getString("CsvConfig", "") + tableName + ".csv", System.Text.Encoding.UTF8);
                    else
    ...
    public class DebugParameter
    {
        ...
        public static bool IsOpenCheckTrageSegmentErrorVh = true;
        public static bool IsOpenForcedPushVhInSameSegmentWithErrorVh = true;
