...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctl_Map : UserControl
    {
        ...
        {
            if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, "Hsinchu"))
            {
            ...
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_OHS100))
            {
                space_Height_m = 160000; //OHS_100
        ...
        {
            foreach (var vhOjb in m_objItemNewVhcl)
            {
