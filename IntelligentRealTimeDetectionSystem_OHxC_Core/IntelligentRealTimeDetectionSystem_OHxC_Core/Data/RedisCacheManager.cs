...
namespace com.mirle.iibg3k0.ids.ohxc.Data
{
    public class RedisCacheManager
    {
        ...
        public RedLockFactory RedLockFactory = null;
        ...
        private static Lazy<ConfigurationOptions> configOptions
               = new Lazy<ConfigurationOptions>(() =>
               {
                   ...
                   configOptions.EndPoints.Add(CSAppConstants.REDIS_SERVER_CONFIGURATION);
        ...
        private ConnectionMultiplexer GetConnection()
        {
            ...
            //    var options = ConfigurationOptions.Parse(CSAppConstants.REDIS_SERVER_CONFIGURATION);
            //    RedisConnection = ConnectionMultiplexer.Connect(options);
            //    RedisServer = RedisConnection.GetServer(options.EndPoints.First());
            //}
        ...
        public bool HashDelete(RedisKey key, RedisValue hashField, When when = When.Always)
        {
            key = $"{productID}_{key}";
            IDatabase db = null;
            db = Database();
